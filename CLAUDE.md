...
`github.com/Arunav9/Skrollit` is **public**. Anyone can read every file and every commit, past and present. Before committing or pushing anything, make sure it contains nothing that could leak something important or cause an unwanted situation:
...
- No personal identifiers that don't need to be public: device UDIDs, Apple Team IDs, personal email addresses, phone numbers, physical addresses, etc. (a bundle identifier like `com.arunav9.skrollit` is fine — it's meant to be public)
